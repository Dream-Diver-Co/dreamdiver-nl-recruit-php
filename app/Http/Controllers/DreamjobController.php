...

{
    ...
    $rules = [
        ...
        $dreamjob_message = new Dreamjob();


    // Assign validated data to the Contact instance
    $dreamjob_message->name = $validatedData['name'];
    $dreamjob_message->email = $validatedData['email'];
    $dreamjob_message->phone = $validatedData['phone'];
    // $contact_message->message = $validatedData['message'];
    $dreamjob_message->note = $validatedData['note'];


        // Save the contact message to the database
        $dreamjob_message->save();
