...
<div class="content-wrapper" >
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Dream Jobs</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Dream Jobs</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach($students as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->note }}</td>
                                                        <td>
                                                            <a href="{{ url('/student/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm" style="height: 30px; width: 65px;"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
